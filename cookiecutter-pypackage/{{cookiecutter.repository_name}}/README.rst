...
(If you are viewing this on GitHub, open the `full documentation <https://{{ cookiecutter.repository_name }}.readthedocs.io/>`__ for additional details.)

.. |PyPI Version| image:: https://img.shields.io/pypi/v/{{ cookiecutter.package_name }}.svg
   :target: https://pypi.org/project/{{ cookiecutter.package_name }}/
.. |Build Status| image:: https://github.com/open-contracting/{{ cookiecutter.repository_name }}/workflows/CI/badge.svg
