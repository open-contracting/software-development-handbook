...
-  A service's codebase has at most 3000 relevant lines, according to `Codecov <https://about.codecov.io>`__.
-  A service's Docker Compose file defines the containers for the backend, frontend and any workers.

When using :doc:`../python/django`, the workers are written as Django `management commands <https://docs.djangoproject.com/en/stable/howto/custom-management-commands/>`__. In other cases, the workers are written as Click commands, sharing code with other commands.
