...
Database administrators need to identify the source of queries, in order to notify developers of inefficient queries or to alert users whose queries will be interrupted by database maintenance. For example:
