...
-  Django `Translation <https://docs.djangoproject.com/en/stable/topics/i18n/translation/>`__
...
.. tab-set::
   ...
   .. tab-item:: Crowdin
      ...
      Install the `Crowdin CLI <https://crowdin.github.io/crowdin-cli/>`__:
...
When using Django, use its `translation functions and template tags <https://docs.djangoproject.com/en/stable/topics/i18n/translation/>`__. Otherwise, use `gettext.gettext() <https://docs.python.org/3/library/gettext.html>`__.
...
For a Django application, reuse the `i18n-django <https://github.com/open-contracting/.github/blob/main/.github/workflows/i18n-django.yml>`__ workflow.
