...
-  Django `Translation <https://docs.djangoproject.com/en/5.2/topics/i18n/translation/>`__
...
When using Django, use its `translation functions and template tags <https://docs.djangoproject.com/en/5.2/topics/i18n/translation/>`__. Otherwise, use `gettext.gettext() <https://docs.python.org/3/library/gettext.html>`__.
