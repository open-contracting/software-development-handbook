...
Use `ManifestStaticFilesStorage <https://docs.djangoproject.com/en/3.2/ref/contrib/staticfiles/#manifeststaticfilesstorage>`__ for cache-busting, unless a package provides its own, like `django-pipeline <https://django-pipeline.readthedocs.io/en/latest/usage.html#cache-busting>`__.
